...
const BillDetails = () => {
  ...
  const totalCartcount=cartItems.reduce((total,item)=>total+item.cartQuantity,0);
    ...
    <div className="bg-white shadow-lg rounded-lg p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <p className="font-semibold text-gray-800">BDT <span className="lws-subtotal">{subTotal}</span></p>
        </div>
        {/* Discount */}
        <div className="flex justify-between items-center">
        ...
        <div className="flex justify-between items-center border-t pt-4">
          ...
          <p className="font-bold text-lg text-blue-600">BDT <span className="lws-total">{subTotal}</span></p>
        </div>
        {/* Place Order Button */}
